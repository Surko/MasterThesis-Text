...
Ďalším, veľmi známym odhadom generalizačnej chyby je $n$ krížová validácia. Pri tomto odhade vytvárame $n$ modelov rovnakého typu. Dáta sú rozdelené na $n$ medzi sebou disjunktných podmnožín, najlepšie rovnakých veľkostí. Model testujeme vždy na jednej z $n$ častí. Ostatných $n-1$ častí slúži ako trénovacia množina (rozdelenie množín je teda v pomere n-1:1). Testovacie chyby $Err_{i}$, získané z každého z $n$ modelov môžeme následne použiť na aproximáciu generalizačnej chyby:
\begin{equation}

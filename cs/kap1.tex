...
Najskôr v časti \ref{kap1:2.5:2.5.1:SplitCriterias} zadefinujeme, čo sú to kritéria delenia a vypíšeme tie najznámejšie z nich. V poslednej časti \ref{kap1:2.5:2.5.4:Generic} ukážeme generický algoritmus na indukciu stromov. 
...
\entropy(C,D_{X_{i} = t}). \label{kap1:2.5:2.5.1:InfoGainDef} 
\end{align}
kde
\begin{equation}
...
\begin{align}
\gainratio(X_{i},D) =
\dfrac{\infogain(X_{i},D)}{\entropy(X_{i},D)} \label{kap1:2.5:2.5.1:GainRatioDef} 
\end{align}
...
\subsection{Vyhodnotenie kvality stromov}\label{kap1:2.5:2.5.2:Evaluation}

\subsection{Orezávanie stromov}\label{kap1:2.5:2.5.3:Pruning}

\subsection{Generický indukčný algoritmus}\label{kap1:2.5:2.5.4:Generic}
Indukčné algoritmy majú za úlohu vytvoriť rozhodovací strom zo zadanej trénovacej množiny $D$. Hlavnou úlohou pri tvorbe je minimalizovať generalizačnú chybu. Nie vždy sa jedná len o minimalizovanie. Algoritmus sa môže snažiť o vytvorenie stromu s čo najnižšou výškou alebo tiež s obmedzeným počtom vrcholov.
...
V ďalších častiach rozoberieme tri najznámejšie indukčné algoritmy na tvorbu stromov. Konkrétne v časti \ref{kap1:2.5:2.5.4:ID3} ukážeme algoritmus ID3. Následne v časti \ref{kap1:2.5:2.5.4:C4.5} predstavíme vylepšený algoritmus C4.5. Pre regresné typy stromov predvedieme v časti \ref{kap1:2.5:2.5.4:CART} obľúbený algoritmus CART.

\subsubsection{ID3}\label{kap1:2.5:2.5.4:ID3}
...
\subsubsection{CART}\label{kap1:2.5:2.5.4:CART}

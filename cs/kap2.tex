...
Bunka je základnou stavebnou jednotkou každého organizmu. Každá bunka má uložený popis ako vyzerá a ako sa má správať pri typických bunečných procesoch. Tento popis sa nazýva genetická informácia a v organizmoch je uskladnená v DNA, čo je obrovská molekula, polymér zložený z veľkého množstva pospájaných nukleotidov (kyselina fosforečná s deoxyribózou a naviazanou dusíkatou bázou). Tieto nukleotidy a konkrétne ich báze sú zodpovedné zato, ako vyzerá genetický kód tejto genetickej informácie. Malý kúsok vybraný zo sekvencie DNA, ktorý kóduje nejakú funkčnosť bunky alebo proces v bunke sa nazýva gén. Gén si je taktiež možné predstaviť ako významnú črtu organizmu (napríklad farba očí).

DNA je kvôli jej veľkosti ďalej komprimovaná do štruktúry nazývaná chromozóm. Ten sa nachádza v jadre bunky. Organizmy môžu mať v jadre viacero rôznych chromozómov. Genóm organizmu je potom genetický materiál zo všetkých chromozómov dokopy. Určitá množina génov z genómu organizmu sa nazýva genotyp. Vo vývojovom štádiu jedinca ovplyvňuje genotyp výzor a ďalšie charakteristiky organizmu, nazývané aj fenotyp.
